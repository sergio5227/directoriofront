  ...
  return (
    <div>
        ...
        <div style={{width:'100%'}}>        
              ...
              {items.map((element,e)=>{
                return (
                  <tr key={e}>
                    ...
                    <td><Image thumbnail  src={element?.imagen}/></td>
                    <td>
                    <ButtonGroup size="sm">
                      <DropdownButton as={ButtonGroup} title="Acciones" id="bg-nested-dropdown">
                        <Dropdown.Item eventKey="1" onClick={()=>props?.onAction('editar',element)}>Edicion</Dropdown.Item>
                        <Dropdown.Item eventKey="2" onClick={()=>props?.onAction('eliminar',element)}>Eliminar</Dropdown.Item>
                      </DropdownButton>
                    </ButtonGroup>
                    </td>
                  </tr>
          ...
          <PaginationComponent onPage={(page)=> setPage(page) } elemenmtos={Math.round(props?.data?.length / 10)  } />
          </div>
